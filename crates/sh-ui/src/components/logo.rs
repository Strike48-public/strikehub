...
/// Strike48 full wordmark SVG, reusable across login and dashboard views.
#[component]
pub fn Strike48Logo(#[props(default = "200px")] width: &'static str) -> Element {
    rsx! {
        svg {
            class: "strike48-logo",
            width: "{width}",
            view_box: "0 0 636.8 163.28",
            ...
            path {
                fill: "#9cbfae",
                d: "M137.55,140.02c-.91.17-1.97.25-3.19.25-1.65,0-3.18-.26-4.58-.78-1.4-.52-2.54-1.52-3.42-2.99-.88-1.47-1.32-3.67-1.32-6.6v-42.76h15.94v-12.15h-15.94v-18.62h-15.13v18.62h-11.39v12.15h11.39v45.9c0,4.69,1.06,8.59,3.19,11.69,2.12,3.1,4.91,5.4,8.35,6.88,3.44,1.48,7.15,2.19,11.13,2.12,2.43-.03,4.45-.23,6.07-.58,1.62-.35,2.87-.7,3.74-1.04l-2.73-12.5c-.51.1-1.21.24-2.13.41Z",
            }
            // "r"
            path {
                fill: "#9cbfae",
                d: "M192.86,73.83c-4.55,0-8.63,1.21-12.22,3.62-3.59,2.41-6.1,5.71-7.51,9.89h-.81v-12.35h-14.62v77.73h15.13v-47.47c0-3.37.81-6.38,2.43-9.03,1.62-2.65,3.82-4.72,6.6-6.22,2.78-1.5,5.96-2.25,9.54-2.25,1.55,0,3.1.11,4.66.33,1.55.22,2.63.41,3.24.58v-14.47c-.74-.1-1.76-.19-3.06-.25-1.3-.07-2.42-.1-3.37-.1Z",
            }
            // "i" dot
            path {
                fill: "#9cbfae",
                d: "M220.08,44.93c-2.63,0-4.88.89-6.76,2.66-1.87,1.77-2.81,3.91-2.81,6.4s.94,4.58,2.81,6.35c1.87,1.77,4.12,2.66,6.76,2.66s4.88-.89,6.76-2.66c1.87-1.77,2.81-3.9,2.81-6.4s-.94-4.58-2.81-6.35c-1.87-1.77-4.12-2.66-6.76-2.66Z",
            }
            // "i" stem
            rect {
                fill: "#9cbfae",
            ...
            polygon {
                fill: "#9cbfae",
                points: "601.17 58.05 604.7 58.05 604.7 67.86 606.71 67.86 606.71 58.05 610.24 58.05 610.24 56.28 601.17 56.28 601.17 58.05",
            }
            // TM "M"
            polygon {
                fill: "#9cbfae",
                points: "623.96 56.28 622.32 56.28 621.88 56.28 618.29 64.78 614.7 56.28 614.26 56.28 612.63 56.28 612.25 56.28 612.25 67.86 614.26 67.86 614.26 59.98 617.76 67.86 618.83 67.86 622.32 59.98 622.32 67.86 624.33 67.86 624.33 56.28 623.96 56.28",
            }
        }
    }
}
